...
<?php } else if($PAGE->theme->settings->fontselect==11) { ?>
	<link href="http://fonts.googleapis.com/css?family=Ubuntu:bold&subset=latin,cyrillic" rel="stylesheet" type="text/css">
...
<?php } else if($PAGE->theme->settings->fontselect==15) { ?>
	<link href="http://fonts.googleapis.com/css?family=Playfair+Display&subset=latin,cyrillic" rel="stylesheet" type="text/css">
